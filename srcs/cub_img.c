...
/*   Updated: 2024/04/04 00:55:39 by yugao            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//This is the function that initializes the img_info type in the t_info parameter
...
//After the above function has been used, this function is responsible for drawing the image in the image we created.
...
//然后会开始新的画布
//When drawing anything, you must start with this function, otherwise you will get an error.
//When running this function, if the old canvas has content, the content of the old canvas will be pushed to the screen immediately.
...
// When ending a canvas, you must end it with this function so that you can push the contents of the canvas to the window and destroy the image.
...
//默认颜色为白色
// Before drawing anything, if you want to change the color, you can change the color with this function.
